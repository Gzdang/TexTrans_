...
def main(tar_path):
    ...
    for p in os.listdir(tar_path):
        ...
        losser = Losser(ref_texture, None, vgg)
        ours.append(losser.get_loss(tar_mask*our_texture))
        tex.append(losser.get_loss(tar_mask*tex_texture))
        painter.append(losser.get_loss(tar_mask*painter_texture))
        paint3d.append(losser.get_loss(tar_mask*paint_texture))
