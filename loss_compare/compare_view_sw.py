    ...
    for cls in os.listdir(tar_path):
        ...
        for idx in sub_list:
            ...
            for i in range(9):
                ...
                with torch.no_grad():
                    ours.append(slicing_loss(our_img, ref_img))
                    tex.append(slicing_loss(tex_img, ref_img))
                    painter.append(slicing_loss(painter_img, ref_img))
                    paint3d.append(slicing_loss(paint_img, ref_img))
