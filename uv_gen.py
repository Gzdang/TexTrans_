...
def main(cfg):
    ...
    ref_img, ref_depth = render_images(cfg.ref_mesh, cfg.ref_texture, size=render_size, n_c=cfg.n_c, out_path=".cache/ref")
    tar_img, tar_depth = render_images(cfg.tar_mesh, cfg.tar_texture, size=render_size, n_c=cfg.n_c, out_path=".cache/tar")
